...
public void createAndDisplayGUI()
    {       
       ...
       ACImage.setImage(ACImage.getImage().getScaledInstance(180, 20, Image.SCALE_DEFAULT));
       ...
       ACImageV.setImage(ACImageV.getImage().getScaledInstance(20, 180, Image.SCALE_DEFAULT));
       //ACPic.setBounds(1165,115,180,20);
       contentPane.add(ACPicV);
        ...
        BSImageV.setImage(BSImageV.getImage().getScaledInstance(20, 180, Image.SCALE_DEFAULT));
        //BSPic.setBounds(1165,115,180,20);
        ...
        SUBImageV.setImage(SUBImageV.getImage().getScaledInstance(20, 130, Image.SCALE_DEFAULT));
        //SUBPic.setBounds(1160,165,130,20);
        ...
        CImageV.setImage(CImageV.getImage().getScaledInstance(20, 130, Image.SCALE_DEFAULT));
        //CPic.setBounds(1165,215,130,20);
        ...
        DImageV.setImage(DImageV.getImage().getScaledInstance(20, 75, Image.SCALE_DEFAULT));
        //DPic.setBounds(1165,270,75,20);
					...
					if(FullSizeAC == true){
						...
						if (JumpShip == false){
							...
							if(Vertical == true){
								...
								ACPic.setVisible(false);
								ACPicV.setBounds(PicX, PicY, 20, 220);
							}else{
					...
					if(FullSizeBS == true){
						...
						if (JumpShip == false){
							...
							if(Vertical == true){
								...
								BSPic.setVisible(false);
								BSPicV.setBounds(PicX, PicY, 20, 190);
							}else{
								BSPic.setVisible(true);
								BSPicV.setVisible(false);
								BSPic.setBounds(PicX,PicY,190,20);
							}
							random = random+1;
						}
					...
					if(FullSizeSUB == true){
						...
						if (JumpShip == false){
							...
							if(Vertical == true){
								...
								SUBPic.setVisible(false);
								SUBPicV.setBounds(PicX, PicY, 20, 130);
							}else{
								SUBPic.setVisible(true);
								SUBPicV.setVisible(false);
								SUBPic.setBounds(PicX,PicY,130,20);
							}
							random = random+1;
						}
						...
						if(FullSizeC == true){
							...
							if (JumpShip == false){
								...
								if(Vertical == true){
									...
									CPic.setVisible(false);
									CPicV.setBounds(PicX, PicY, 20, 130);
								}else{
									CPic.setVisible(true);
									CPicV.setVisible(false);
									CPic.setBounds(PicX,PicY,130,20);
								}
								random = random+1;
							}
						...
						if(FullSizeD == true){
							...
							if (JumpShip == false){
								...
								if(Vertical == true){
									...
									DPic.setVisible(false);
									DPicV.setBounds(PicX, PicY, 20, 75);
								}else{
									DPic.setVisible(true);
									DPicV.setVisible(false);
									DPic.setBounds(PicX,PicY,75,20);
								}
								random = 0;
							}
					...
					for (int i = 0; i < strArray.length; i++){
							...
							if(count == 2 && FullSizeSUB == true){	
								...
								if(JumpShip == false){
									...
									if(Vertical == true){
										SUBPicV.setVisible(true);
										SUBPicV.setBounds(PicX, PicY, 20, 180);
									}else{
										SUBPic.setVisible(true);
										SUBPic.setBounds(PicX,PicY,180,20);
									}
								}else{
									FullSizeSUB =false;
									JOptionPane.showMessageDialog(null, "Abondon Ship!");
					...
					for (int i = 0; i < strArray.length; i++){
							...
							if(count == 2 && FullSizeC == true){										
								...
								if(JumpShip == false){
									...
									if(Vertical == true){
										CPicV.setVisible(true);
										CPicV.setBounds(PicX, PicY, 20, 180);
									}else{
										CPic.setVisible(true);
										CPic.setBounds(PicX,PicY,180,20);
									}
								}else{
									FullSizeC =false;
									JOptionPane.showMessageDialog(null, "Abondon Ship!");
