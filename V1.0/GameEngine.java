...
public class GameEngine extends JFrame {
	...
	int ShipX;
	int ShipY;
	int ASx, ASy, BSx, BSy, SSx, SSy, CSx, CSy, DSx, DSy = 0;
	public int z1 = 0;
	public int z2 = 0;
	static int PicX = 0;
	static int PicY = 0;
	...
	public void createAndDisplayGUI() {
		...
		// buttonLeftPanel.setLayout(new BoxLayout(buttonLeftPanel,
		// BoxLayout.Y_AXIS));
		...
		/*
		 * Dimension D = new Dimension(); D = aCarrier.getPreferredSize();
		...
		Output.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				 ...
				 * System.out.println("ACcoordinates"+Arrays.toString(
				 * AircraftCoordinates));
				 * System.out.println("BSpoints"+Arrays.toString(BSpoints));
				 * System.out.println("BScoordinates"+Arrays.toString(
				 * BattleShipCoordinates));
				 * System.out.println("SUBpoints"+Arrays.toString(SUBpoints));
				 * System.out.println("SUBcoordinates"+Arrays.toString(
				 * SubmarineCoordinates));
				 * System.out.println("Cpoints"+Arrays.toString(Cpoints));
				 * System.out.println("Ccoordinates"+Arrays.toString(
				 * CruiserCoordinates));
				 * System.out.println("Dpoints"+Arrays.toString(Dpoints));
				 * System.out.println("Dcoordinates"+Arrays.toString(
				 * DestroyerCoordinates)); System.out.println("  ");
				 * System.out.println("  ");
				 */
			}
		});
		...
		aCarrier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane.showMessageDialog(null,
						"Pick first and last coordinate for" + " your AircraftCarrier (5 spaces long)");
		...
		bShip.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane.showMessageDialog(null,
						"Pick first and last coordinate for" + " your BattleShip (4 spaces long)");
			}
		});
		...
		cSub.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane.showMessageDialog(null,
						"Pick first and last coordinate for" + " your Submarine (3 spaces long)");
			}
		});
		...
		dCruiser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane.showMessageDialog(null,
						"Pick first and last coordinate for" + " your Cruiser (3 spaces long)");
			}
		});
...

		{
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane.showMessageDialog(null,
						"Pick first and last coordinate for" + " your Destroyer (2 spaces long)");
			}
		});
		...
		// Can't put any ships on the board b4 using hard wire it wont move the
		// black boxes

		RandomizeShips.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				/*
				 * if (random == -1){ FullSizeAC = false; FullSizeBS = false;
				 * FullSizeSUB = false; FullSizeC = false; FullSizeD = false;
				 * random = 0; }
				 */
				...
				if (random == 0) {
					...
					while (next == false) {
						...
						ACPic.setVisible(false);
						// takeCoordinates(0, 0, AircraftCoordinates,
						// FullSizeAC,4);
						// takeCoordinates(4, 0, AircraftCoordinates,
						// FullSizeAC,4);
				...
				if (random == 1) {
					...
					while (next == false) {
						...
						BSPic.setVisible(false);
						// takeCoordinates(0, 1, BattleShipCoordinates,
						// FullSizeBS,3 );
						// takeCoordinates(3, 1, BattleShipCoordinates,
						// FullSizeBS,3 );
				...
				if (random == 2) {
					...
					while (next == false) {
						...
						SUBPic.setVisible(false);
						// takeCoordinates(0, 2, SubmarineCoordinates,
						// FullSizeSUB,2 );
						// takeCoordinates(2, 2, SubmarineCoordinates,
						// FullSizeSUB,2 );
				...
				if (random == 4) {
					...
					while (next == false) {
						...
						DPic.setVisible(false);
						// takeCoordinates(0, 4, DestroyerCoordinates,
						// FullSizeD,1 );
						// takeCoordinates(1, 4, DestroyerCoordinates,
						// FullSizeD,1 );
		...
		// ----------------------------------------------------------------------------------------------------------------
		// ----------------------------------------------------------------------------------------------------------------
		// Brings back a button after the ship has been set on the board (more
		// to come)
		...
		FinalizeShips.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (FullSizeAC == true && FullSizeBS == true && FullSizeSUB == true && FullSizeC == true
						&& FullSizeD == true) {
					...
					public void actionPerformed(ActionEvent ae) {
						if (AircraftCarrier == true) {
							...
							if (count == 2 && FullSizeAC == true) {
								...
								JOptionPane.showMessageDialog(null,
										"Repick your second coordinate or press Set Aircraft Carrier to start again");
								count = 1;
							...
							if (count == 2 && FullSizeBS == true) {
								...
								JOptionPane.showMessageDialog(null,
										"Repick your second coordinate or press Set BattleShip to start again");
								count = 1;
								button[z1].setBackground(Color.BLUE);
							}
							...
							if (count == 2 && FullSizeSUB == true) {
								...
								JOptionPane.showMessageDialog(null,
										"Repick your second coordinate or press Set Submarine to start again");
								count = 1;
								button[z1].setBackground(Color.BLUE);
							}
							...
							if (count == 2 && FullSizeC == true) {
								...
								JOptionPane.showMessageDialog(null,
										"Repick your second coordinate or press Set Cruiser to start again");
								count = 1;
								button[z1].setBackground(Color.BLUE);
							}
							...
							if (count == 2 && FullSizeD == true) {
								...
								JOptionPane.showMessageDialog(null,
										"Repick your second coordinate or press Set Destroyer to start again");
								count = 1;
								button[z1].setBackground(Color.BLUE);
							}
						}
						 ...
						 * ADDED_TEXT); Action = but.getActionCommand(); String
						 * [] strArray = Action.split(","); int [] intArray =
						 * new int [strArray.length];
						 * 
						 * for (int i = 0; i < strArray.length; i++) {
						 * intArray[i] = Integer.parseInt(strArray[i]); x =
						 * intArray[0]; y = intArray[1]; } aCarrier(x,y);
						 */
		...
		/*
		 * ImageIcon BackgroundWater = new ImageIcon("Background water.jpg"); //
		 * load the image to a imageIcon Image image =
		 * BackgroundWater.getImage(); // transform it Image newimg =
		 * image.getScaledInstance(120, 120, java.awt.Image.SCALE_SMOOTH); //
		 * scale it the smooth way BackgroundWater = new ImageIcon(newimg); //
		 * transform it back contentPane.add(BackgroundWater)
		 */
	...
	// Almost there just can't get this method to change the FullSize bo0leans
	// ie. FullsizeAC wont change when Full changes
	...
	// Places ship on board and checks for overlap (might want to split to two
	// methods)
	public static void FillInShip(Integer[] Coor, int x, Integer[] blocks) {
		...
		// the puts them in an array matchPoints at
		// AC(0-4)+BS(10-14)+SUB(20-24)+C(30-34)+D(40-44)
	...
	// Takes ship off the board and replaces the 'overlap block' for the other
	// ship
	...
	public JPanel displayChat() {
		...
		messageField.addActionListener(new ActionListener() {// hit enter to
																// send text
	...
	public boolean validShips() {
		boolean result = false;
		int count = 0;
		for (int i = 0; i < 5; i++) {
			for (int j = 0; j < 20; j = j + 2) {
				if (ACpoints[i] != null) {
					if ((ACpoints[i] == ((ShipLocation[j] * 10) + ShipLocation[j + 1]))) {
						count++;
						System.out.print("Add1");
					}
				}
				if (BSpoints[i] != null) {
					if ((BSpoints[i] == ((ShipLocation[j] * 10) + ShipLocation[j + 1]))) {
						count++;
						System.out.print("Add1");
					}
				}
				if (Cpoints[i] != null) {
					if ((Cpoints[i] == ((ShipLocation[j] * 10) + ShipLocation[j + 1]))) {
						count++;
						System.out.print("Add1");
					}
				}
				if (SUBpoints[i] != null) {
					if ((SUBpoints[i] == ((ShipLocation[j] * 10) + ShipLocation[j + 1]))) {
						count++;
						System.out.print("Add1");
					}
				}
				if (Dpoints[i] != null) {
					if ((Dpoints[i] == ((ShipLocation[j] * 10) + ShipLocation[j + 1]))) {
						count++;
						System.out.print("Add1");
					}
				}
