...
public class HomeScreen extends JFrame {
    ...
    public HomeScreen() {
		...
		LeaderBoardB.setBounds(160,181,200,100);
		...
		LeaderBoardB.setForeground(lightBlue);
		LeaderBoardB.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));
		
		Chat.setBounds(160,281,200,100);
		Chat.setOpaque(false);
		Chat.setContentAreaFilled(false);
		Chat.setBorderPainted(true);
		Chat.setFont(new Font("Serif", Font.BOLD, 24));
		Chat.setForeground(lightBlue);
		Chat.setBorder(BorderFactory.createLineBorder(Color.WHITE, 2));	

		Options.setBounds(160,381,200,100);
		...
		Help.setBounds(160,481,200,100);
